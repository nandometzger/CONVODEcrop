...
parser.add_argument('-PU', '--part-update', default=False, type=bool, help="only for swissmaps data. Update only parts of the hidden state that are observed. Usefull for partly observed maps.")
